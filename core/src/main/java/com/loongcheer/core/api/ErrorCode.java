    ...
    public static AdError getErrorCode(String code, String platformCode, String platformMsg) {
        switch (code) {
            ...
            case dataLevelLowError:
                return new AdError(dataLevelLowError, "Upload data level is FORBIDDEN, must called 'LCSDK.setGDPRUploadDataLevel' to set the level.", platformCode, platformMsg);
            case networkError:
